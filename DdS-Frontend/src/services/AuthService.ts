...
export class AuthService {
   ...
   */
  static async registerDriver(driverData: DriverRegistrationData): Promise<void> {
    try {
   ...
   */
  static async registerDispatcher(dispatcherData: DispatcherRegistrationData): Promise<void> {
    try {
      // Register the user in auth
